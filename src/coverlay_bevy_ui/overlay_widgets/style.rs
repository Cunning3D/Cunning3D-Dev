...
use egui_wgpu::sdf::{create_sdf_circle_callback, create_sdf_rect_callback, GpuTextUniform, SdfCircleUniform, SdfRectUniform};
...
impl OverlayTheme {
    ...
    pub fn from_ui(ui: &egui::Ui) -> Self {
        ...
        Self {
            ...
            palette_strip_cols: 4,
            palette_strip_cell_px: s(11.0),
            sep_opacity: 0.20,
            sep_thickness: s(2.0),
    ...
    #[inline]
    pub fn darken(c: Color32, t: f32) -> Color32 { Self::lerp_color(c, Color32::BLACK, t) }

    #[inline]
    pub fn lighten(c: Color32, t: f32) -> Color32 { Self::lerp_color(c, Color32::WHITE, t) }
...
#[inline]
pub fn animate_hover(ctx: &Context, id: Id, hovered: bool) -> f32 {
    ctx.animate_value_with_time(id.with("hover"), if hovered { 1.0 } else { 0.0 }, 0.12)
}

#[inline]
pub fn animate_select(ctx: &Context, id: Id, selected: bool) -> f32 {
    ctx.animate_value_with_time(id.with("sel"), if selected { 1.0 } else { 0.0 }, 0.15)
}

#[inline]
pub fn animate_toggle(ctx: &Context, id: Id, on: bool) -> f32 {
    ctx.animate_value_with_time(id.with("tog"), if on { 1.0 } else { 0.0 }, 0.18)
}
...
pub fn paint_sdf_rect(ui: &mut Ui, rect: Rect, rounding: CornerRadius, fill: Color32, border: Color32, border_w: f32) {
    ...
    // Keep it single-layer: do NOT expand, avoid "double wrapped" look.
