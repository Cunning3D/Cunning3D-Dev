...
impl Painter {
    ...
    pub fn paint_primitives(
        ...
        // NOTE: egui-wgpu may output SDF primitives; egui_glow doesn't support them directly.
        // We tessellate them to meshes here as a compatibility fallback.
        let mut tess = Tessellator::new(pixels_per_point, TessellationOptions::default(), [1, 1], Vec::new());
