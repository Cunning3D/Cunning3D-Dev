    ...
    pub fn on_window_event(
        ...
        match event {
            ...
            WindowEvent::Ime(ime) => {
                ...
                // after Commit.
                //
                // We use ime_event_enable/disable to keep IME state consistent across platforms.
                match ime {
            ...
            | WindowEvent::SmartMagnify { .. } => EventResponse {
                repaint: false,
                consumed: false,
            },
            ...
            WindowEvent::TouchpadRotate { delta, .. } => {
                ...
                // egui uses clockwise-positive angles.
                self.egui_input.events.push(egui::Event::Rotate(-*delta as f32));
                EventResponse {
                    repaint: true,
                    consumed: self.egui_ctx.wants_pointer_input(),
                }
...
fn to_egui_theme(theme: winit::window::Theme) -> egui::Theme {
    match theme {
