...
impl Default for Spacing {
    fn default() -> Self {
        Self {
            item_spacing: vec2(3.0, 1.0),        // Houdini-style: ultra compact
            window_margin: Margin::same(2),      // Houdini-style: minimal margin
            menu_margin: Margin::same(2),
            button_padding: vec2(4.0, 2.0),      // Houdini-style: tiny padding
            indent: 14.0,                        // Houdini-style: tight indent
            interact_size: vec2(32.0, 16.0),     // Houdini-style: small controls
            slider_width: 80.0,                  // Houdini-style: narrower sliders
            slider_rail_height: 3.0,             // Houdini-style: thin rail
            combo_width: 80.0,
            text_edit_width: 200.0,
            icon_width: 12.0,                    // Houdini-style: small icons
...
impl Widgets {
    pub fn dark() -> Self {
        Self {
            ...
            hovered: WidgetVisuals {
                ...
                fg_stroke: Stroke::new(1.0, Color32::from_gray(240)),
                corner_radius: CornerRadius::same(2),    // Windows: no rounding change on hover
                expansion: 0.0,                          // Windows: no expansion on hover
            },
            active: WidgetVisuals {
                ...
                corner_radius: CornerRadius::same(2),
                expansion: 0.0,                          // Windows: no expansion on active
            },
            open: WidgetVisuals {
    ...
    pub fn light() -> Self {
        Self {
            noninteractive: WidgetVisuals {
                weak_bg_fill: Color32::from_gray(243),
                bg_fill: Color32::from_gray(243),
            ...
            inactive: WidgetVisuals {
                ...
                bg_stroke: Stroke::new(1.0, Color32::from_gray(180)), // Windows: visible border
                fg_stroke: Stroke::new(1.0, Color32::from_gray(40)),
                corner_radius: CornerRadius::same(2),
                expansion: 0.0,
            },
            hovered: WidgetVisuals {
                weak_bg_fill: Color32::from_gray(210),
                bg_fill: Color32::from_gray(210),
                bg_stroke: Stroke::new(1.0, Color32::from_gray(140)),
                fg_stroke: Stroke::new(1.0, Color32::BLACK),
                corner_radius: CornerRadius::same(2),
                expansion: 0.0,                          // Windows: no expansion
            },
            active: WidgetVisuals {
                weak_bg_fill: Color32::from_gray(190),
            ...
            open: WidgetVisuals {
                weak_bg_fill: Color32::from_gray(215),
