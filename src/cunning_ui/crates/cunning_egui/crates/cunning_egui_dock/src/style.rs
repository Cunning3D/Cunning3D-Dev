...
pub struct TabBarStyle {
    ...
    /// Tab rounding. By `Default` it's [`CornerRadius::default`].
    ...
    /// If `true`, do not render the tab bar when there is only one tab in the leaf.
...
pub struct TabBodyStyle {
    /// Inner margin of tab body. By `Default` it's `Margin::same(4)`.
    ...
    pub fn from_egui(style: &egui::Style) -> Self {
        Self {
            ...
            rounding: CornerRadius {
                nw: style.visuals.widgets.inactive.corner_radius.nw.saturating_add(2),
                ne: style.visuals.widgets.inactive.corner_radius.ne.saturating_add(2),
                sw: 0,
                se: 0,
            },
...
impl OverlayStyle {
    ...
    pub fn from_egui(style: &egui::Style) -> Self {
        Self {
            selection_color: style.visuals.selection.bg_fill,
