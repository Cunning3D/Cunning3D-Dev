...
| `Style::tab_outline_color`                      | `tabs_system::outline_color`                            |
| `Style::hline_color`                            | `tabs_system::hline_color`                              |
| `Style::hline_below_active_tab_name`            | `tabs_system::hline_below_active_tab_name`              |
| `Style::tab_rounding`                           | `tabs_system::rounding`                                 |
| `Style::tab_background_color`                   | `tabs_system::bg_fill`                                  |
| `Style::tab_text_color_unfocused`               | `tabs_system::text_color_unfocused`                     |
| `Style::tab_text_color_focused`                 | `tabs_system::text_color_focused`                       |
| `Style::tab_text_color_active_unfocused`        | `tabs_system::text_color_active_unfocused`              |
| `Style::tab_text_color_active_focused`          | `tabs_system::text_color_active_focused`                |
| `Style::expand_tabs`                            | `tabs_system::fill_tab_bar`                             |
