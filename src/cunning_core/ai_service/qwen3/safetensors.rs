...
use super::super::common::is_flash_attention_available;
use super::super::models_api::optimization::OptimizationConfig;
...
impl Qwen3Backend {
    ...
    pub fn from_safetensors(
        ...
        if use_flash {
            bevy::log::info!("⚡ Loading Qwen3 with Flash Attention (bf16/f16 + CUDA)");
        } else {
            bevy::log::info!("Loading Qwen3 with standard attention");
        }
