...
namespace manifold_rs
{
    ...
    public:
        ...
        /// @brief Get the OriginalID of this manifold instance
    ...
    public:
        ...
        /// @brief  Get the face IDs of the mesh (if available)
        std::unique_ptr<std::vector<uint32_t>> face_ids() const;

        /// @brief Get the OriginalID runs of the mesh (if available)
        std::unique_ptr<std::vector<uint32_t>> run_original_id() const;

        /// @brief Get the run start indices (in triVerts) of the mesh (if available)
        std::unique_ptr<std::vector<uint32_t>> run_index() const;
    ...
    /// @param face_ids Face IDs (optional, can be empty)
    /// @return A new mesh
