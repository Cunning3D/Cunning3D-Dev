...
#[derive(Default)]
pub struct ForEachConnectivityNode;

impl NodeParameters for ForEachConnectivityNode {
...
impl NodeOp for ForEachConnectivityNode {
...
crate::register_node!("ForEach Connectivity", "Flow", crate::nodes::flow::foreach_connectivity::ForEachConnectivityNode;
